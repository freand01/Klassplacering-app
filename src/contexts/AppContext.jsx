...
export const ACTIONS = {
  ...
  LOAD_ROOM_LAYOUT: 'LOAD_ROOM_LAYOUT',
  SAVE_PLAN: 'SAVE_PLAN',
  ...
  switch (action.type) {
    ...
    case ACTIONS.ADD_CONSTRAINT:
      return {
        ...
        data: {
          ...state.data,
          constraints: [...state.data.constraints, action.payload]
        }
      };
    ...
    case ACTIONS.REMOVE_CONSTRAINT:
      return {
        ...
        data: {
          ...state.data,
          constraints: state.data.constraints.filter(c => c.id !== action.payload)
        }
      };
    ...
    case ACTIONS.SAVE_ROOM_LAYOUT:
      return {
        ...
        data: {
          ...state.data,
          roomLayouts: [...(state.data.roomLayouts || []), action.payload]
        }
      };
    ...
    case ACTIONS.DELETE_ROOM_LAYOUT:
      return {
        ...
        data: {
          ...state.data,
          roomLayouts: state.data.roomLayouts.filter(l => l.id !== action.payload)
        }
      };
    ...
    case ACTIONS.SAVE_PLAN:
      return {
        ...
        data: {
          ...state.data,
          plans: [action.payload, ...state.data.plans]
        }
      };
    ...
    case ACTIONS.DELETE_PLAN:
      return {
        ...
        data: {
          ...state.data,
          plans: state.data.plans.filter(p => p.id !== action.payload)
        }
      };
    ...
    case ACTIONS.UPDATE_ACTIVE_PLAN:
      return {
        ...state,
        data: updateActivePlan(state.data, action.payload.classId, action.payload.updates)
      };

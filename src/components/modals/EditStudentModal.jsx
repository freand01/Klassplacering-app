      ...
      <div className="bg-white rounded-2xl shadow-2xl p-6 w-full max-w-sm animate-scale-in border border-gray-100">
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-3">
            ...
            <label className="flex items-center gap-3 p-3 border-2 border-gray-200 rounded-xl cursor-pointer hover:bg-gradient-to-r hover:from-blue-50 hover:to-sky-50 hover:border-blue-300 transition-all duration-200 active-press">
              <input
                type="checkbox"
                checked={solo}

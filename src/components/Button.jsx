...
const Button = ({
  ...
  const baseStyle = "px-4 py-2.5 rounded-xl font-semibold transition-all duration-200 flex items-center gap-2 print:hidden justify-center focus:outline-none focus:ring-2 focus:ring-offset-2 active-press relative overflow-hidden group";
  ...
  const variants = {
    ...
    danger: "bg-gradient-to-r from-red-500 to-pink-500 text-white hover:from-red-600 hover:to-pink-600 border-0 focus:ring-red-500 shadow-lg shadow-red-500/30 hover:shadow-xl hover:shadow-red-500/40 hover:scale-105",
